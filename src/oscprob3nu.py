...
----------------
    ...
    * evolution_operator_u_coefficients - Returns the :math:`u_k`
...
def evolution_operator_u_coefficients(hamiltonian_matrix, L):
...
def evolution_operator_3nu(hamiltonian_matrix, L):
    ...
    u0, u1, u2, u3, u4, u5, u6, u7, u8 = \
        evolution_operator_u_coefficients(hamiltonian_matrix, L)
...
# u_coeffs = evolution_operator_u_coefficients(hamiltonian_matrix, 1.0)
# print("u = ", u_coeffs)
# print()
