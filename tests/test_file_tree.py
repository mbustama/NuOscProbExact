...
TREE = [
    ...
    ('img/anim_cp.gif', 'The demonstration reel, one scene per file'),
    ('img/anim_earth.gif', None),
    ('img/anim_slabs.gif', None),
    ('img/anim_sterile.gif', None),
    ...
    ('img/gallery/gallery_long_range.png', None),
    ...
    ('notebooks/20_arbitrary_hamiltonian.ipynb',
     'A long-range force, carried through three profiles'),
    ...
    ('resources/paper/', 'Source of the paper that documents this library'),
    ('resources/paper/README.md', 'How to build it, and what each file is'),
    ('resources/paper/HANDOVER-magnus-fig11.md',
     'What another paper needs to redraw Figure 11 with its own code on it'),
    ('resources/paper/main.tex', 'The paper; BibTeX, no inlined bibliography'),
    ('resources/paper/make_versions.py',
     'Derives the clean and the diffed versions'),
    ('resources/paper/baseline_cpc_v1.tex',
     'The published version, for the diff'),
    ('resources/paper/refs.bib', 'The bibliography, read by BibTeX at build'),
    ('resources/paper/elsarticle.cls', None),
    ('resources/paper/elsarticle-num.bst', None),
    ('resources/paper/figs/', 'Every figure, fourteen of them from notebook 10'),
    ('resources/paper/figs/validation.pdf', None),
    ('resources/paper/figs/prob_2nu_vs_energy_compare.pdf', None),
    ('resources/paper/figs/prob_3nu_vs_energy_compare.pdf', None),
    ('resources/paper/figs/slabs_composition.pdf', None),
    ('resources/paper/figs/earth_oscillogram.pdf', None),
    ('resources/paper/figs/density_arrangement.pdf', None),
    ('resources/paper/figs/sterile_earth_oscillogram.pdf', None),
    ('resources/paper/figs/architecture.pdf', None),
    ...
    ('resources/paper/figs/speed_accuracy_combined.pdf', None),
    ('resources/paper/figs/lri_earth.pdf', None),
    ('resources/paper/figs/Notes_on_SU_n__probability_relations.pdf', None),
    ('resources/tools/', 'Tooling for the paper, not for the library'),
    ('resources/tools/manuscript/',
     'Checks the prose of main.tex against the criteria beside them'),
    ('resources/tools/manuscript/CHECKLIST.md',
     'The audit criteria the paper is held to'),
    ('resources/tools/manuscript/audit_section.py',
     'The mechanical criteria, one section at a time'),
    ('resources/tools/manuscript/check_apparatus_prose.py',
     'Prose about the manuscript rather than about neutrinos'),
    ('resources/tools/manuscript/check_convolution.py',
     'Sentence shapes a reader has to unpick: abstract predicates and echoed heads'),
    ('resources/tools/manuscript/check_dangles.py',
     'Dangling last lines, over the typeset page'),
    ('resources/tools/manuscript/check_informality.py',
     'Colloquial register in a technical text'),
    ('resources/tools/manuscript/check_llm_tells.py',
     'Vocabulary and rhythms that read as machine-written'),
    ('resources/tools/manuscript/check_numerals.py',
     'Every quoted number, ranked by how badly it could be wrong'),
    ('resources/tools/manuscript/check_oxford.py',
     'Three-item lists missing the serial comma'),
    ('resources/tools/manuscript/check_paragraphs.py',
     'Paragraph length and sentence count, from the source'),
    ('resources/tools/manuscript/check_scale_words.py',
     'Adjectives of scale standing where a number should'),
    ('resources/tools/manuscript/check_voice.py',
     'Passive rate and first-person density, by section'),
    ('resources/tools/manuscript/check_weak_prose.py',
     'Hedges, nominalizations, filler and vague reference'),
    ...
    ('tests/bench/FINDINGS.md',
     'What that check broke, and how each claim was verified'),
    ...
    ('tests/bench/gen_conversions.py',
     'Emits conversions.h so no adapter carries a physical literal'),
    ...
    ('tests/bench/adapters/nufast_lbl.cpp',
     'NuFast-LBL, one batched call over the whole energy vector'),
    ('tests/bench/adapters/prob3.cpp',
     'Prob3++, looped in C++ because that is its interface'),
    ('tests/bench/adapters/globes.cpp',
     'GLoBES, looped, chord decomposition hoisted'),
    ('tests/bench/adapters/nuoscprobexact.py', 'This library, batched'),
    ('tests/bench/adapters/second_order.py',
     'The second-order expansion in alpha and s13, as a measured point'),
    ('tests/bench/adapters/nusquids.py',
     'nuSQuIDS through its multiple-energy constructor'),
    ('tests/bench/adapters/nucraft.py',
     'nuCraft, whose batching is interface-only'),
    ('tests/bench/runner.py',
     'The Python harness; the only place Python timing happens'),
    ('tests/bench/reference.py',
    ...
    ('tests/test_bench_behaviour.py',
     'What an adapter does, not where its constants came from'),
    ...
    ('tests/measure_performance_scaling.py',
     'Freezes the three call routes against stack size, on a quiet machine'),
    ('tests/performance_scaling.json',
     'That measurement, which the performance figure reads'),
    ('tests/prem_scan.py',
